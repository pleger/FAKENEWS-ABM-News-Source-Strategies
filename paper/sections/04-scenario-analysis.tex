...
\begin{table}[ht]
\centering
\caption{RQ3 mechanism audit for the combined-imitation diagnostic re-executions. Observed rates are calculated from 30 seeds and 400 periods; discovery is per 1,000 receiver-periods and penalty is per covered recommendation.}
...
\caption{Structural sensitivity of false-decision-share effects across user activity and network topology. Points are paired means and bars are unadjusted 95\% Monte Carlo intervals across ten seeds.}\label{fig:rq4-structural}
\end{figure}
